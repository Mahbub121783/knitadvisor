...
const { TCX_COLORS, _byCode, _nameIndex, _byFamily, _detectFamily, TOTAL_COLORS, UNIQUE_CODES, COLOR_FAMILIES } = require('../catalog/tcx-database');
const { SCOTDIC_COLORS, _byCode: _scotdicByCode, TOTAL_COLORS: SCOTDIC_TOTAL } = require('../catalog/scotdic-database');
const { BROS_COLORS, _byCode: _brosByCode, TOTAL_COLORS: BROS_TOTAL } = require('../catalog/bros-database');
const { ARCHROMA_COLORS, _byCode: _archromaByCode, TOTAL_COLORS: ARCHROMA_TOTAL } = require('../catalog/archroma-database');
// ============================================================
