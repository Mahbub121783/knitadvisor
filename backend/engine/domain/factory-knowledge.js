...
const FAB_BUCKET_ALIAS = {
  ...
  // so the fabric loses its factory reference and drops to the published
  // regression — and TIGHTNESS_LIMITS[alias || 'default'] hands it the generic
  // band instead of pique's. Both failures look like normal output.
  lacoste_double: 'pique',
